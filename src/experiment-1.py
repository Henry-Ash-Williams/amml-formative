...
if __name__ == "__main__":
    print("Experiment 1:\n")
    print(
        "Investigates the performance of a VAE trained on a dataset without spatial transformations\n"
    )
    print("Training...\n")
    model, test_loss, train_loss = train(train_base)
    torch.save(model, "E1-model.pt")
    pickle.dump(test_loss, open("E1-test-loss.pickle", "wb"))
    pickle.dump(train_loss, open("E1-train-loss.pickle", "wb"))
